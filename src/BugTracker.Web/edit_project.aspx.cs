...
namespace btnet
{
    ...
    public partial class edit_project : BasePage
    {
        ...
        protected void Page_Load(Object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                default_user.DataSource =
                    DbUtil.get_dataview(new SQLString("select us_id, us_username from users order by us_username"));
        ...
        Boolean validate()
        {
            ...
            vals_error_string = Util.validate_dropdown_values(custom_dropdown_values1.Value);
            ...
            vals_error_string = Util.validate_dropdown_values(custom_dropdown_values2.Value);
            if (!string.IsNullOrEmpty(vals_error_string))
            {
                good = false;
            ...
            vals_error_string = Util.validate_dropdown_values(custom_dropdown_values3.Value);
            if (!string.IsNullOrEmpty(vals_error_string))
            {
                good = false;
