<%@ Page Language="C#" CodeBehind="send_email.aspx.cs" Inherits="btnet.send_email" ValidateRequest="false" AutoEventWireup="True" MasterPageFile="~/LoggedIn.Master" %>
...
<asp:Content runat="server" ContentPlaceHolderID="headerScripts">
    ...
    <script type="text/javascript">
        ...
        function include_bug_click() {
            if (document.getElementById('<%=include_bug.ClientID%>').checked) {
                document.getElementById('<%=include_internal_posts.ClientID%>').disabled = false;
                document.getElementById('<%=include_internal_posts_label.ClientID%>').style.color = 'black';
            }
            else {
                document.getElementById('<%=include_internal_posts.ClientID%>').disabled = true;
                document.getElementById('<%=include_internal_posts.ClientID%>').style.color = 'gray';
            }
        }
                    ...
                    <form class="frm" runat="server" enctype="multipart/form-data">
                        <table border="0">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input runat="server" type="text" class="txt" id="subject" maxlength="200" size="100" /></td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input runat="server" type="file" class="txt" id="attached_file" maxlength="255" size="100" /></td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:CheckBoxList ID="lstAttachments" runat="server"></asp:CheckBoxList></td>
                                <td></td>
                            </tr>
                            ...
                            <tr>
                                <td colspan="2">
                                    <input runat="server" type="checkbox" class="txt" id="include_bug" />Include print of <% Response.Write(btnet.Util.get_setting("SingularBugLabel", "Bug")); %></td>
                            </tr>

                            <tr>
                                <td colspan="2">
                                    <input runat="server" type="checkbox" class="txt" id="include_internal_posts" /><span id="include_internal_posts_label" runat="server" />Include comments visible to internal users only</td>
                            </tr>
